...
export default function Card({
  ...
  // const hideshowReplyForm = (e) => {
  //   setShowReplyForm(false);
  // };

  // const submitReplyHandler = () => {
  //   submitHandler(comment.id);
  //   setShowReplyForm(false);
  // };
  ...
  return (
    <div className="card-container">
      <div className="comment-section">
        <div className="card">
          <img
            ...
            alt={comment.id}
          />
          <p className="time">{comment.timeCommented}</p>
          ...
          <div className="like-btn-continer">
            <div>
              ...
              <span id="numbers-of-like">{comment.like}</span>
              <button
                onClick={() => {
                  unLikehandler(comment.id);
      ...
      {showReplyForm && (
        <EditForm
          reply={reply}
          editedInputHandler={replyInput}
          classname="reply-form"
          text="Reply"
          UpdateComment={submitReplyHandler}
        />
      )}
    </div>
  );
